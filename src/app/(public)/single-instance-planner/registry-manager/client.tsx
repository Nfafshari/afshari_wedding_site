...
import { ChevronLeft, CirclePlus, Gift } from "lucide-react";
...
export default function RegistryManager() {
  const { registryItems } = useDemoPlanner();
  ...
  // Summary stats, reduced here rather than aggregated in SQL — as on the budget page.
