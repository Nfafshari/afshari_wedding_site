...
/** The icon used when a name doesn't resolve — matches the add dialog's initial pick. */
export const DEFAULT_DOC_ICON = Lucide.FileChartColumn;

/**
 * Turns a displayName back into its component.
 *
 * The dialogs and actions pass icons around as strings (a name survives a form field;
 * a component does not), but an ArchivedDoc stores the component itself. This is where
 * the two meet. Lives beside ICON_LIBRARY so the pickable set and the resolvable set
 * cannot drift apart.
 */
