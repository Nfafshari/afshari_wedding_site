...
import AddCategoryDialog from "./checklist-dialogs/add-category-dialog";
import AddTaskDialog from "./checklist-dialogs/add-task-dialog";
import EditCategoryDialog from "./checklist-dialogs/edit-category-dialog";
import RemoveTaskDialog from "./checklist-dialogs/remove-task-dialog";
...
export default function Checklist() {
  const { taskCategories: categories } = useDemoPlanner();
